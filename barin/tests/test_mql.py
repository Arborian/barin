    ...
    def test_or(self):
        self.assertEqual(
            {'$or': [
                {'x': {'$gt': 5}},
                {'x': {'$lt': 15}}]},
            mql.or_(self.MyDoc.m.f.x > 5, self.MyDoc.m.f.x < 15))
